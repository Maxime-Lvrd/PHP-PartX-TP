...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // validation de company
    $company = filter_input(INPUT_POST, 'company', FILTER_SANITIZE_STRING);
    if (empty($company)) {
        $errors['company'] = 'Veuillez renseigner le nom de votre compagnie.';
    }
}
        ...
        <div class="row justify-content-center mt-5 ">
            <div class="col-7 bg-dark text-white p-3 ">
                <div class="form-group">
                    ...
                    <select name="civility" class="form-control <?= $isSubmitted && isset($errors['civility']) ? 'is-invalid' : '' ?>" 
                    id="civility">
        ...
        <div class="bg-dark text-white p-3">
            <div class="row">
                ...
                <div class="col">
                    ...
                    <p><a class='text-white' href="upload.php">Télecharger une photo de profil</a></p>
                </div>
            </div>
        </div>
    </div>

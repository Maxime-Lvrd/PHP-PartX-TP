...
<div class="d-flex justify-content-center mt-3">
    <form action="" method="post" class="col-6 border p-3 bg-dark text-white">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="birthdate" id="birthdate" placeholder="jj / mm / aaaa">
        </div>
        <div class="form-group">
            ...
            <select class="form-control" name="birthcountry" id="birthcountry">
                ...
                <option value="MadÃ¨re">Madère </option>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="adress" id="adress" placeholder="60 Avenue des Champs-Elysées">
        </div>
        <div class="row">
            <div class="col-6 form-group">
                <label for="cp">Code postal</label>
                <input type="text" class="form-control" name="cp" id="cp" placeholder="75000">
            </div>
            <div class="col-6 form-group">
        ...
        <div class="form-group">
            ...
            <input type="tel" class="form-control" name="telephone" id="telephone" placeholder="00 00 00 00 00">
        </div>
        <div class="form-group">
            <label for="diploma">Diplômes</label>
            <select class="custom-select" name="diploma" id="diploma">
        ...
        <div class="form-group">
            <label for="polemploinb">Numéro Pôle Emploi</label>
            <input type="number" class="form-control" name="polemploinb" id="polemploinb"
                placeholder="000000000000">
        </div>
        <div class="form-group">
            <label for="badgesnb">Nombre de badges</label>
            <select class="custom-select" name="badgesnb" id="badgesnb">
                <option value="none">Aucun</option>
        ...
        <div class="form-group">
            ...
            <input type="url" class="form-control" name="codecademylink" id="codecademylink"
                placeholder="Lien codecademy">
        </div>
        <div class="form-group">
            <label for="hero">Si vous étiez un super héros/une super héroïne, qui seriez-vous et pourquoi ?</label>
            <textarea class="form-control" name="hero" id="hero"></textarea>
        </div>
        <div class="form-group">
            <label for="hack">Racontez-nous un de vos "hacks" (pas forcément technique ou informatique)</label>
            <textarea class="form-control" name="hack" id="hack"></textarea>
        </div>
        <div class="form-group">
            <label for="xp">Avez vous déjà eu une expérience avec la programmation et/ou l'informatique avant de remplir
                ce formulaire ?</label>
            <textarea class="form-control" name="xp" id="xp"></textarea>
        </div>
...
<p><?= $_POST['telephone']; ?></p>
<p><?= $_POST['diploma']; ?></p>
<p><?= $_POST['polemploinb']; ?></p>
<p><?= $_POST['badgesnb']; ?></p>
<p><?= $_POST['codecademylink']; ?></p>
<p><?= $_POST['hero']; ?></p>
<p><?= $_POST['hack']; ?></p>
<p><?= $_POST['xp']; ?></p>
